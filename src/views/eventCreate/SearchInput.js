...
import { updateFilteredDataEvent, updateSearchQuery } from 'src/store/slice/eventSlice'
...
const SearchInput = () => {
    ...
    const filterData = (query) => {
      ...
      dispatch(updateFilteredDataEvent(filteredData));
    };
  ...
  return (
    ...
    <div onClick={()=>router.push('/createevent/addEvent')} style={{
        width: 160,
        height: 40,
